...
gatilho: >
  Executar sempre que o artigo finalizado pelo @copywriter-seo contiver tabela,
  grid comparativo ou componente visual estruturado. Executar antes do @qa-conteudo.
entrada:
...
**Se nenhum estiver presente, não executar esta task — avançar direto para @qa-conteudo.**
...
```
APROVADO         → avançar para @qa-conteudo (auditar-artigo.md)
AJUSTE           → retornar para @copywriter-seo com lista de correções
