---
title: "Para Que Serve uma Nota Fiscal Eletrônica?"
description: "Descubra para que serve uma nota fiscal eletrônica, quando o MEI é obrigado a emitir, as diferenças entre NF-e, NFS-e e NFC-e, e o que acontece se você não emitir."
pubDate: 2026-03-20
...
breadcrumb:
  ...
  - label: "Blog"
    href: "/blog/"
  - label: "Para Que Serve uma Nota Fiscal Eletrônica"
faq:
  - question: "Para que serve uma nota fiscal eletrônica?"
    answer: "A nota fiscal eletrônica comprova uma venda ou prestação de serviço, protege você legalmente, é exigida por clientes empresariais e é obrigatória em diversas situações dependendo da sua atividade."
  - question: "MEI é obrigado a emitir nota fiscal eletrônica?"
    answer: "Não sempre. O MEI só é obrigado a emitir NF-e quando vende para pessoa jurídica (empresa). Para consumidor final pessoa física, a emissão é opcional, mas pode ser exigida pelo cliente."
  - question: "Qual a diferença entre NF-e e NFS-e?"
    answer: "NF-e é para venda de produtos. NFS-e é para prestação de serviços. O MEI que vende produtos emite NF-e pela SEFAZ do estado. O MEI que presta serviços emite NFS-e pela prefeitura do município."
  - question: "O que acontece se não emitir nota fiscal quando obrigado?"
    answer: "A empresa pode ser autuada com multa. Para o MEI, a multa pode chegar a 50% do valor da operação ou valor mínimo fixado pelo estado. Além disso, o cliente pode recusar o pagamento sem a nota."
  - question: "Nota fiscal eletrônica tem prazo de cancelamento?"
    answer: "Sim. O prazo padrão é de 24 horas após a autorização da nota. Após esse prazo, o cancelamento não é mais aceito e você precisa emitir uma nota de devolução ou carta de correção."
---
...
1. Acesse o portal da SEFAZ do seu estado (cada estado tem o seu)
2. Cadastre-se como emissor de NF-e
3. Para MEI, muitos estados oferecem emissor gratuito no próprio portal
4. Preencha os dados da venda, o CNPJ do destinatário, o produto e o valor
5. Transmita e guarde o XML e o DANFE (o documento impresso da nota)
...
Para confirmar sua obrigatoriedade específica, consulte a legislação do estado e o contador. Se você ainda não tem suporte contábil, veja como escolher uma [contabilidade online para MEI](/melhores-contabilidades-online) sem complicar.
...
Se você ainda não emitiu nenhuma nota fiscal eletrônica, o primeiro passo é identificar qual tipo você precisa (NF-e ou NFS-e) e se cadastrar no portal correto. Para quem quer entender melhor como funciona a parte fiscal do MEI como um todo, o artigo sobre [como abrir um MEI](/blog/como-abrir-um-mei/) tem o contexto completo da formalização.
